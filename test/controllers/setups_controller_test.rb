...
class SetupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create setup" do
    assert_difference('Setup.count') do
      post setups_url, params: { setup: { average_bill: @setup.average_bill, website_id: @setup.website_id, yandex_net_fee: @setup.yandex_net_fee, yandex_share: @setup.yandex_share } }
    end
  ...
  test "should update setup" do
    patch setup_url(@setup), params: { setup: { average_bill: @setup.average_bill, website_id: @setup.website_id, yandex_net_fee: @setup.yandex_net_fee, yandex_share: @setup.yandex_share } }
