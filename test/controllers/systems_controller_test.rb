...
class SystemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create system" do
    assert_difference('System.count') do
      post systems_url, params: { system: { description: @system.description, name: @system.name, payment_type: @system.payment_type } }
    end
  ...
  test "should update system" do
    patch system_url(@system), params: { system: { description: @system.description, name: @system.name, payment_type: @system.payment_type } }
